...
(800802, 0, 0, 0, 0, 0, 21417, 0, 0, 0, '(Imposter) High Mage', 'Imposter', NULL, 0, 80, 80, 1, 14, 0, 1.2, 1.14286, 1, 1, 20, 1, 3, 0, 10, 2000, 2000, 1, 1, 2, 64, 2048, 0, 0, 0, 0, 0, 0, 7, 108, 22950, 0, 0, 0, 0, 210895, 403505, 'SmartAI', 0, 1, 115, 2500, 1, 1, 0, 167, 1, 617299839, 0, 1073741824, 'boss_high_nethermancer_zerevor', 12340);
